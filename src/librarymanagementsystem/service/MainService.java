...
public class MainService {
    ...
    public static void mockData() {
        ...
        Author stefan = new Author("Stefan", "Zweig",
                "Stefan Zweig was born in 1881 in Vienna, into a wealthy Austrian-Jewish family. He studied in Berlin and Vienna and was first known as a poet and translator, then as a biographer. Between the wars, Zweig was an international bestseller… ");
        ...
        Material material4 = new Material(MaterialType.BOOK, "The Metamorphosis", Category.CLASSICS,
                new Date(201511),
                kafka, yapiKredi, 88, "B1",
                "As Gregor Samsa awoke one morning from uneasy dreams he found himself transformed in his bed into a gigantic insect. He was laying on his hard, as it were armor-plated, back and when he lifted his head a little he could see his domelike brown belly divided into stiff arched segments on top of which the bed quilt could hardly keep in position and was about to slide off completely. His numerous legs, which were pitifully thin compared to the rest of his bulk, waved helplessly before his eyes.",
                library2);
        Material material5 = new Material(MaterialType.MAGAZINE, "National Geographic", Category.HISTORY,
                new Date(2021512),
                natGeoTeam, natGeo, 200, "A3",
    ...
    /**
     * Create a new library with the given name and city, and add it to the list of
     * libraries.
     *
    ...
    /**
     * If the username exists in the database, and the password matches the password
     * in the database, return the account
     *
    ...
    /**
     * If the username is not already in the database, create a new user with the
     * given parameters and return true,
    ...
    /**
     * If the username is not taken, create a new LibraryManager account with the
     * given parameters
     *
    ...
    /**
     * > If the account does not exist, create a new librarian account with the
     * given parameters
     *
    ...
    /**
     * Find the publisher with the given name, and return the list of books that
    ...
    /**
     * Given an author's name, return a list of all the books that author has
     * written.
     *
    ...
    /**
     * It returns an ArrayList of Strings that contains the names of all the
     * categories
     *
    ...
    /**
     * It takes in a category choice, and returns an ArrayList of Material objects
     * that have that category
     *
     * @param categoryChoice The category choice is the number that the user inputs
    ...
    /**
     * It takes a name and a city as parameters, creates a new library object with
     * the given name and city, and adds it to
     * the library list
     *
     * @param name    The name of the library.
    ...
    /**
     * If the publisher and author of the new material don't exist in the database,
     * add them. Then add the material
     *
    ...
    /**
     * This function takes a string as an argument and searches for a material with
     * that name. If it finds a material with
     ...
     * @param info            a string that contains any additional information
     *                        about the material
     * @param lib             The library that the material is in.
     * @return A new Material object.
     */
    public static Material addMaterial(MaterialType type, String name, int category, Date publicationDate,
            Author author,
